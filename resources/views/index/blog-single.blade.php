...
<body>
	...
	<div id="page-content">
		<div class="container">
			<h1 class="text-center decor color">Blog Post</h1>
			<div class="row">
				<div class="col-md-9 column-center">
					...
					<div class="comments">
						...
						<div class="comment">
							<div class="userpic"><span class="icon icon-users"></span></div>
							<div class="text">
								...
								<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam enim enim, pharetra in sodales at, interdum sit amet dui. Nullam vulputate euismod urna non pharetra. Phasellus blandit mattis ipsum, ac laoreet lorem lacinia et. Cras et ligula libero.</p>
							</div>
						</div>
						<div class="comment replay">
							...
							<div class="text">
								<div class="meta"><b>Paul Johnson</b> | <a href="#">Reply</a></div>
								<div class="date"><i class="icon icon-clock"></i><span>Thursday, May 02, 2017</span></div>
								<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam enim enim, pharetra in sodales at, interdum sit amet dui. Nullam vulputate euismod urna non pharetra. Phasellus blandit mattis ipsum, ac laoreet lorem lacinia et. Cras et ligula libero.</p>
							</div>
						</div>
					</div>
					<div class="divider-lg"></div>
					<h5 class="color">LEAVE A COMMENT</h5>
					...
					<form class="contact-form" name="contactform" method="post">
						...
						<button type="submit" id="submit" class="btn">Leave a Comment</button>
					</form>
				...
				<div class="col-md-3 column-right">
					...
					<div class="side-block">
						...
						<div class="blog-post post-preview">
							<div class="post-image">
								<a href="blog-single.html"><img src="images/blog/blog-post-featured-1.jpg" alt=""></a>
							</div>
							<ul class="post-meta">
								<li><i class="icon icon-clock"></i><span>Thursday, May 01, 2017</span></li>
						...
						<div class="blog-post post-preview">
							<div class="post-image">
								<a href="blog-single.html"><img src="images/blog/blog-post-featured-2.jpg" alt=""></a>
							</div>
							<ul class="post-meta">
								<li><i class="icon icon-clock"></i><span>Thursday, May 01, 2017</span></li>
								<li class="pull-right"><i class="icon icon-comments"></i><span>3</span></li>
