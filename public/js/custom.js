...
$document.ready(function () {
    ...
    $("#slide-nav").on("click", toggler, function (e) {
        ...
        $('#page-content, .navbar-fixed-top, body, .navbar-header').toggleClass('slide-active');
    });
    var selected = '#slidemenu, #page-content, body, .navbar-fixed-top, .navbar-header';
    // END slide menu
        ...
        $contactform.validate({
            ...
            messages: {
                ...
                phone: {
                    ...
                    minlength: "Tu nombre de teléfono debe tener al menos 6 caracteres"
                },
            },
        ...
        $requestForm.validate({
            ...
            submitHandler: function (form) {
                $(form).ajaxSubmit({
                    ...
                    error: function () {
                        $('#requestform').fadeTo("slow", 0, function () {
                            $('#requestError').fadeIn();
                        });
                    }
                });
...
/*---------------------------------
 ...
 ----------------------------------*/
$(document).ready(function () {
    var altura = $('#slidemenu').offset().top;

    $(window).on('scroll', function () {
        if ($(window).scrollTop() > altura) {
            $('#slidemenu').addClass('stick');
        } else {
            $('#slidemenu').removeClass('stick');
        }
    });
